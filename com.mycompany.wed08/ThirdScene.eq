...
public class ThirdScene : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        base.initialize(rsc);
        add_entity(SESpriteEntity.for_color(Color.instance("#33CC33"), get_scene_width(), get_scene_height()));
        ...
        but2 = add_sprite_for_color(Color.instance("#0099FF"), 0.25*get_scene_width(), 0.25*get_scene_height());
        but2.move(0.75*get_scene_width(),0.7*get_scene_height());

        but3 = add_sprite_for_color(Color.instance("white"), 0.25*get_scene_width(), 0.25*get_scene_height());
       ...
       rsc.prepare_font("myfont","ariel bold color=#551a8b",40);
        ...
        text2=add_sprite_for_text("		I'm Blue","myfont");
        text2.move(0.75*get_scene_width(),0.7*get_scene_height());

        text3=add_sprite_for_text("		Go to Main","myfont");
