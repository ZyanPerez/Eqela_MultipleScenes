...
{    SESprite but1;
    ...
    public void initialize(SEResourceCache rsc) {
        base.initialize(rsc);
        add_entity(SESpriteEntity.for_color(Color.instance("#E62E00"), get_scene_width(), get_scene_height()));

    but1 = add_sprite_for_color(Color.instance("white"), 0.25*get_scene_width(), 0.25*get_scene_height());
       ...
       rsc.prepare_font("myfont","ariel bold color=#551a8b",40);
        ...
        text5=add_sprite_for_text("		Go to Main","myfont");
