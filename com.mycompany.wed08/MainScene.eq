...
public class MainScene : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        base.initialize(rsc);
        color1 = add_sprite_for_color(Color.instance("#E62E00"), 0.5*get_scene_width(), 0.5*get_scene_height());
        color1.move(0,0);

        color2 = add_sprite_for_color(Color.instance("#0099FF"), 0.5*get_scene_width(), 0.5*get_scene_height());
        color2.move(0.5*get_scene_width(),0);

        color3 = add_sprite_for_color(Color.instance("#33CC33"), 0.5*get_scene_width(), 0.5*get_scene_height());
        color3.move(0,0.5*get_scene_height());

        color4 = add_sprite_for_color(Color.instance("#FFFF66"), 0.5*get_scene_width(), 0.5*get_scene_height());
